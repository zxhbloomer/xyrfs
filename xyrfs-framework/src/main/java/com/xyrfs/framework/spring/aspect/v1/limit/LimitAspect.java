package com.xyrfs.framework.spring.aspect.v1.limit;

import com.google.common.collect.ImmutableList;
import com.xyrfs.common.annotations.LimitAnnotion;
import com.xyrfs.common.enums.LimitTypeEnum;
import com.xyrfs.common.exception.redis.LimitAccessException;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.xyrfs.common.annotations.LimitAnnotion)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        log.info("IP:{} 第 {} 次访问key为 {}，说明为 [{}] 的接口", ip, count, keys, name);
